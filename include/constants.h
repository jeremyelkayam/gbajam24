...
namespace aru 
{
    ...
    constexpr const line_info TUTORIAL_CUTSCENE_DIALOGUE[7] = {
        ...
        {"Perfect!! Well, far from it, actually. It seems most systems are only operating in quite a basic state. While you're out there, I'll see if I can tune those up a bit. My automated retrieval unit... Get retrieving! ",  2, bn::sprite_items::slung_portrait_neutral}
    };
